...
<body>
    <div class="d-flex align-items-start">
        ...
        <div class="sidebar shadow">
            ...
            <nav class="mt-3">
                <a href="/" class="<?php echo e(Request::is('/') ? 'active-link' : ''); ?>">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                </a>
                <a href="/satwa" class="<?php echo e(Request::is('satwa*') ? 'active-link' : ''); ?>">
                    <i class="bi bi-search me-2"></i> Pilihan Satwa
                </a>
                <a href="/kuis" class="<?php echo e(Request::is('kuis') ? 'active-link' : ''); ?>">
                    <i class="bi bi-controller me-2"></i> Kuis Interaktif
                </a>
                <a href="/profile" class="<?php echo e(Request::is('profile') ? 'active-link' : ''); ?>">
...
</html><?php /**PATH C:\xampp\Documents\htdocs\info-satwa\resources\views/layouts/app.blade.php ENDPATH**/ ?>