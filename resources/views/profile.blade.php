...
<div class="row g-4 pb-5">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card h-100 team-card shadow-lg">
            <div class="photo-wrapper p-3">
                <img src="{{ asset('img/ergi.JPG') }}" class="w-100 rounded-4" alt="Ergi">
            </div>
            <div class="card-body d-flex flex-column pt-0 text-center">
                <h5 class="fw-800 text-kuning mb-1">{{ strtoupper('Muhammad Ergi') }}</h5>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card h-100 team-card shadow-lg">
            <div class="photo-wrapper p-3">
                <img src="{{ asset('img/upi.JPG') }}" class="w-100 rounded-4" alt="Ergi">
            </div>
            <div class="card-body d-flex flex-column pt-0 text-center">
                <h5 class="fw-800 text-kuning mb-1">{{ strtoupper('Lutfhiani Fauziah') }}</h5>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card h-100 team-card shadow-lg">
            <div class="photo-wrapper p-3">
                <img src="{{ asset('img/arip.JPG') }}" class="w-100 rounded-4" alt="Ergi">
            </div>
            <div class="card-body d-flex flex-column pt-0 text-center">
                <h5 class="fw-800 text-kuning mb-1">{{ strtoupper('Muhamad Arief Nur Cahyo') }}</h5>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card h-100 team-card shadow-lg">
            <div class="photo-wrapper p-3">
                <img src="{{ asset('img/rezky.JPG') }}" class="w-100 rounded-4" alt="Ergi">
            </div>
            <div class="card-body d-flex flex-column pt-0 text-center">
                <h5 class="fw-800 text-kuning mb-1">{{ strtoupper('M. Rezky Rahmawan') }}</h5>
