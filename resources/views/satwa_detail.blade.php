    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="sticky-md-top" style="top: 100px;">
                <img src="{{ asset('img/' . $animal->gambar) }}" class="img-fluid rounded-5 shadow-lg border border-4 border-hutan" alt="{{ $animal->nama }}">
            </div>
        </div>

        <!-- Bagian Informasi (Kanan) -->
        <div class="col-md-7">
            <h1 class="fw-800 text-hutan display-5 mb-1">{{ strtoupper($animal->nama) }}</h1>
            <p class="text-oranye fw-bold fs-5 mb-4 text-uppercase" style="letter-spacing: 2px;">
                <i class="bi bi-tree-fill me-2"></i>Habitat: Satwa {{ $animal->habitat }}
            </p>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    <div class="p-3 bg-white rounded-4 shadow-sm border-bottom border-hutan border-4">
                        ...
                        <span class="fw-bold text-hutan">{{ $animal->asal}}</span>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 bg-hutan rounded-4 shadow-sm border-bottom border-oranye border-4 text-kuning">
                        ...
                        <span class="fw-bold">{{ $animal->populasi}}</span>
                    </div>
                </div>
            </div>
